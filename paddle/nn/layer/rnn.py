...
def split_states(states, bidirectional=False, state_components=1):
    ...
    Parameters:
        states (Tensor|tuple|list): the concatenated states for RNN network.
            ...
            `state_components` Tensors that meet the requirements.txt described
            above. 
    ...
    def get_initial_states(self,
        ...
        Returns:
            init_states (Tensor|tuple|list): tensor of the provided shape and 
                dtype, or list of tensors that each satisfies the requirements.txt,
...
class BiRNN(Layer):
    ...
    Notes:
        ...
        it satisfies the requirements.txt of the cells.
