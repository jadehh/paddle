...
class CompositeMetric(MetricBase):
    ...
    def update(self, preds, labels):
        ...
        Args:
            preds(numpy.array): predicted results of current mini-batch, the shape and dtype of which should meet the requirements.txt of the corresponded metric.
            labels(numpy.array): ground truth of current mini-batch, the shape and dtype of which should meet the requirements.txt of the corresponded metric.
        """
