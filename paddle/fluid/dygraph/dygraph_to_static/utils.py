...
class IsControlFlowVisitor(gast.NodeVisitor):
    ...
    If returns True,
    gast.If.test must meet at least one of the following requirements.txt:
    ...
    gast.While must meet at least one of the requirements.txt 1 to 5:
        4. has `break` statement.
        5. has `continue` statement.
    gast.For must meet at least one of the requirements.txt 4 to 8:
