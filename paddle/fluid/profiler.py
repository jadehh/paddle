...
def cuda_profiler(output_file, output_mode=None, config=None):
    """
    API cuda_profiler has been abandoned. If you have relevant requirements.txt, you can use `paddle.utils.profiler.start_profiler` and `paddle.utils.profiler.stop_profiler`.
