...
def train100():
    ...
    return reader_creator(
        paddle18.dataset.common.download(CIFAR100_URL, 'cifar', CIFAR100_MD5),
        'train')
...
def train10(cycle=False):
    ...
    """
    return reader_creator(
        paddle18.dataset.common.download(CIFAR10_URL, 'cifar', CIFAR10_MD5),
        'data_batch',
        cycle=cycle)
