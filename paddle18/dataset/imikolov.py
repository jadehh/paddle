...
def build_dict(min_word_freq=50):
    ...
    with tarfile.open(
            paddle18.dataset.common.download(paddle18.dataset.imikolov.URL,
                                           'imikolov',
                                           paddle18.dataset.imikolov.MD5)) as tf:
...
def reader_creator(filename, word_idx, n, data_type):
    def reader():
        with tarfile.open(
                paddle18.dataset.common.download(
                    paddle18.dataset.imikolov.URL, 'imikolov',
                    paddle18.dataset.imikolov.MD5)) as tf:
...
def fetch():
    paddle18.dataset.common.download(URL, "imikolov", MD5)
