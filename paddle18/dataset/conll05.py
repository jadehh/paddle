...
"""
Conll05 dataset.
paddle18 semantic role labeling Book and demo use this dataset as an example.
...
import gzip
import itertools
import paddle18.dataset.common
import paddle18.compat as cpt
from six.moves import zip, range

__all__ = ['test, get_dict', 'get_embedding']

DATA_URL = 'http://paddle18models.bj.bcebos.com/conll05st/conll05st-tests.tar.gz'
DATA_MD5 = '387719152ae52d60422c016e92a742fc'
WORDDICT_URL = 'http://paddle18models.bj.bcebos.com/conll05st%2FwordDict.txt'
WORDDICT_MD5 = 'ea7fb7d4c75cc6254716f0177a506baa'
VERBDICT_URL = 'http://paddle18models.bj.bcebos.com/conll05st%2FverbDict.txt'
VERBDICT_MD5 = '0d2977293bbb6cbefab5b0f97db1e77c'
TRGDICT_URL = 'http://paddle18models.bj.bcebos.com/conll05st%2FtargetDict.txt'
TRGDICT_MD5 = 'd8c7f03ceb5fc2e5a0fa7503a4353751'
EMB_URL = 'http://paddle18models.bj.bcebos.com/conll05st%2Femb'
...
def get_dict():
    ...
    """
    word_dict = load_dict(
        paddle18.dataset.common.download(WORDDICT_URL, 'conll05st', WORDDICT_MD5))
    verb_dict = load_dict(
        paddle18.dataset.common.download(VERBDICT_URL, 'conll05st', VERBDICT_MD5))
    label_dict = load_label_dict(
        paddle18.dataset.common.download(TRGDICT_URL, 'conll05st', TRGDICT_MD5))
...
def get_embedding():
    ...
    """
    return paddle18.dataset.common.download(EMB_URL, 'conll05st', EMB_MD5)
...
def test():
    ...
    reader = corpus_reader(
        paddle18.dataset.common.download(DATA_URL, 'conll05st', DATA_MD5),
...
def fetch():
    ...
    paddle18.dataset.common.download(VERBDICT_URL, 'conll05st', VERBDICT_MD5)
    paddle18.dataset.common.download(TRGDICT_URL, 'conll05st', TRGDICT_MD5)
    paddle18.dataset.common.download(EMB_URL, 'conll05st', EMB_MD5)
    paddle18.dataset.common.download(DATA_URL, 'conll05st', DATA_MD5)
