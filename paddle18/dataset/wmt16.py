...
def __load_dict(tar_file, dict_size, lang, reverse=False):
    dict_path = os.path.join(paddle18.dataset.common.DATA_HOME,
...
def train(src_dict_size, trg_dict_size, src_lang="en"):
    ...
    paddle18.dataset.wmt16 provides a tokenized version of the original dataset by
    ...
    return reader_creator(
        tar_file=paddle18.dataset.common.download(DATA_URL, "wmt16", DATA_MD5,
                                                "wmt16.tar.gz"),
...
def get_dict(lang, dict_size, reverse=False):
    ...
    "Please invoke paddle18.dataset.wmt16.train/test/validation first "
    "to build the dictionary."
    tar_file = os.path.join(paddle18.dataset.common.DATA_HOME, "wmt16.tar.gz")
...
def fetch():
    ...
    """
    paddle18.v4.dataset.common.download(DATA_URL, "wmt16", DATA_MD5,
                                      "wmt16.tar.gz")
