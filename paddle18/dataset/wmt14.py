...
http://paddle18paddle18.bj.bcebos.com/demo/wmt_shrinked_data/wmt14.tgz and
parse training set and test set into paddle18 reader creators.
...
# will be add later.
URL_TRAIN = ('http://paddle18models.bj.bcebos.com/wmt/wmt14.tgz')
MD5_TRAIN = '0791583d57d5beb693b9414c5b36798c'
# BLEU of this trained model is 26.92
URL_MODEL = 'http://paddle18models.bj.bcebos.com/wmt%2Fwmt14.tgz'
...
def train(dict_size):
    ...
    return reader_creator(
        paddle18.dataset.common.download(URL_TRAIN, 'wmt14', MD5_TRAIN),
...
def get_dict(dict_size, reverse=True):
    ...
    tar_file = paddle18.dataset.common.download(URL_TRAIN, 'wmt14', MD5_TRAIN)
    src_dict, trg_dict = __read_to_dict(tar_file, dict_size)
    if reverse:
...
def fetch():
    paddle18.dataset.common.download(URL_TRAIN, 'wmt14', MD5_TRAIN)
    paddle18.dataset.common.download(URL_MODEL, 'wmt14', MD5_MODEL)
