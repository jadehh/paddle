...
and parse train/test set intopaddle18 reader creators.
...
from paddle18.dataset.image import *
from paddle18.reader import *
from paddle18 import compat as cpt
import os
import numpy as np
...
DATA_URL = 'http://paddle18models.bj.bcebos.com/flowers/102flowers.tgz'
LABEL_URL = 'http://paddle18models.bj.bcebos.com/flowers/imagelabels.mat'
SETID_URL = 'http://paddle18models.bj.bcebos.com/flowers/setid.mat'
