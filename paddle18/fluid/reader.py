# Copyright (c) 2019 paddle18paddle18 Authors. All Rights Reserved.
#
...
class GeneratorLoader(DataLoaderBase):
    ...
    def set_sample_list_generator(self, reader, places=None):
        with program_guard(Program(), Program()):
            ...
            paddle18_reader = feeder.decorate_reader(reader, multi_devices=False)

        def __tensor_reader_impl__():
            for slots in paddle18_reader():
...
class PyReader(DataLoaderBase):
    ...
    Examples:
        ...
        .. code-block:: python
           ...
           reader.decorate_sample_list_generator(
               paddle18.batch(user_defined_reader, batch_size=BATCH_SIZE))
	...
	Example:
	    .. code-block:: python
                ...
                reader.decorate_sample_list_generator(
                    paddle18.batch(generator, batch_size=BATCH_SIZE))
    ...
    def decorate_sample_generator(self,
        ...
        :code:`decorate_sample_list_generator(paddle18.batch(sample_generator, ...))` .
    ...
    def decorate_sample_list_generator(self, reader, places=None):
        ...
        Example:
            .. code-block:: python
                ...
                user_defined_generator = random_image_and_label_generator(784, 784)
                reader.decorate_sample_list_generator(
                    paddle18.batch(user_defined_generator, batch_size=BATCH_SIZE),
                    fluid.core.CPUPlace())
