...
from paddle18.fluid.proto import data_feed_pb2
...
class InMemoryDataset(DatasetBase):
    ...
    Example:
        dataset = paddle18.fluid.DatasetFactory().create_dataset("InMemoryDataset")
    """
    ...
    def global_shuffle(self, fleet=None, thread_num=12):
        ...
        Examples:
            .. code-block:: python
              ...
              import paddle18.fluid as fluid
              from paddle18.fluid.incubate.fleet.parameter_server.pslib import fleet
              dataset = fluid.DatasetFactory().create_dataset("InMemoryDataset")
              filelist = ["a.txt", "b.txt"]
              dataset.set_filelist(filelist)
              dataset.load_into_memory()
