...
import contextlib
import numpy as np
from paddle18.fluid import core
from paddle18.fluid import framework
...
def guard(place=None):
    ...
    Parameters:
        place(fluid.CPUPlace or fluid.CUDAPlace, optional): Place to execute dygraph. 
            If None, the running place will be determined according to the way of paddle18 compilation. Default: None
