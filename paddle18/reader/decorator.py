    ...
    Examples:
        ...
        .. code-block:: python
         ...
         def reader():
             yield "h"
             yield "i"
         map_reader_result = paddle18.reader.map_readers(func, reader)
    """
...
def shuffle(reader, buf_size):
    """
    paddle18.fluid.io.shuffle ( :ref:`api_fluid_io_shuffle` ) is recommended to use,
    and paddle18.reader.shuffle is an alias.
...
def chain(*readers):
    ...
    **Note**:
        ``paddle18.reader.chain`` is the alias of ``paddle18.fluid.io.chain``, and
        ``paddle18.fluid.io.chain`` is recommended to use.
    ...
    Examples:
        ..  code-block:: python
            ...
            c = paddle18.reader.chain(reader_creator_3(0), reader_creator_3(10), reader_creator_3(20))
            for e in c():
                print(e)
            # Output:
            # [0, 0, 0]
...
def firstn(reader, n):
    """
    paddle18.fluid.io.firstn ( :ref:`api_fluid_io_firstn` ) is recommended to use,
    and paddle18.reader.firstn is an alias.
...
def multiprocess_reader(readers, use_pipe=True, queue_size=1000):
    ...
    .. code-block:: python
        ...
        import paddle18.fluid as fluid
        from paddle18.fluid.io import multiprocess_reader
        import numpy as np
